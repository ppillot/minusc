...
this.htPar.put ("bp",  Clazz.newArray (-1, ["bpShear", "bpStretch", "bpStagger", "bpPropeller", "bpBuckle", "bpOpening"]));
this.htPar.put ("bpChiLambda",  Clazz.newArray (-1, ["bpChi1", "bpLambda1", "bpChi2", "bpLambda2"]));
this.htPar.put ("bpDistTor",  Clazz.newArray (-1, ["bpDistC1C1", "bpDistNN", "bpDistC6C8", "bpTorCNNC"]));
this.htPar.put ("step",  Clazz.newArray (-1, ["stShift", "stSlide", "stRise", "stTilt", "stRoll", "stTwist"]));
this.htPar.put ("hel",  Clazz.newArray (-1, ["heXDisp", "heYDisp", "heRise", "heIncl", "heTip", "heTwist"]));
this.reader = reader;
...
var bsRes = vwr.ms.getAtoms (1095763988, Integer.$valueOf (t.substring (0, pt)));
bsRes.and (bsChain);
bs.or (bsRes);
} catch (e) {
if (Clazz.exceptionOf (e, Exception)) {
