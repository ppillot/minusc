...
if (propToks[i] != 1716520985 && !JS.T.tokAttr (propToks[i], 1078984704)) this.invArg ();
...
if (fileName.equalsIgnoreCase ("clipboard") || !this.vwr.haveAccess (JV.Viewer.ACCESS.ALL)) fileName = null;
 else if (isCommand && argCount != this.slen && this.tokAt (pt + 1) == 1048583 && pt + 3 == argCount) {
pt += 2;
fileName += "." + JS.SV.sValue (this.tokenAt (pt, args));
}break;
default:
...
var data = (property == null ? this.e.getBitsetProperty (bs, tok, null, null, null, null, false, 2147483647, false) : this.vwr.getDataObj (property, bs, 1));
