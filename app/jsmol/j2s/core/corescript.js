...
if (this.isNewSet && this.nTokens > 2 && this.tokAt (2) == 1048583 && (this.tokAt (3) == 1276117011 || this.tokAt (3) == 1141899269 || this.tokAt (3) == 1276384261 || this.tokAt (3) == 1276383249)) {
...
var isUserVar = this.lastToken.tok != 1048583 && !this.isDotDot && this.isContextVariable (this.identLC);
...
this.theToken = JS.SV.newSV ((this.identLC.indexOf ("property_") == 0 ? 1716520985 : 1073741824), 2147483647, this.ident).setName (myName);
...
case 135270926:
if (this.nTokens == 2) {
if (this.lastToken.tok == 4120 || this.lastToken.tok == 1716520985) this.iHaveQuotedString = true;
...
case 160:
case 96:
allowMathFunc = (isUserFunction || $var.intValue == 1276118019 || tok2 == 480 || tok2 == 224);
$var.intValue |= tok2;
...
this.wasX = true;
break;
}if (op.tok == 269484097 && tok0 == 1276116994) {
break;
...
if (this.oStack[this.oPt].tok == 1276116994) return this.evaluateFunction (269484096);
this.oPt--;
return true;
case 269484241:
