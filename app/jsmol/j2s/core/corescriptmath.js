...
Clazz_load (null, "JS.MathExt", ["java.lang.Float", "$.Number", "java.util.Date", "$.Hashtable", "$.Random", "JU.AU", "$.BS", "$.CU", "$.Lst", "$.M4", "$.Measure", "$.P3", "$.P4", "$.PT", "$.Quat", "$.SB", "$.V3", "J.api.Interface", "J.atomdata.RadiusData", "J.c.VDW", "J.i18n.GT", "JM.BondSet", "JS.SV", "$.ScriptParam", "$.T", "JU.BSUtil", "$.Escape", "$.JmolMolecule", "$.Logger", "$.Parser", "$.Point3fi"], function () {
...
case 1276116994:
case 269484096:
return this.evaluateArray (mp, args);
case 135266307:
case 135270418:
...
case 1276118019:
if (op.tok == 269484241) return this.evaluateDotDist (mp, args, tok, op.intValue);
case 135266305:
case 1746538509:
...
pattern = "/noaromatic" + (allMaps || bestMap ? "/" : " nostereo/") + this.e.getSmilesExt ().getSmilesMatches ((hMaps ? "H" : ""), null, bs1, null, false, true, false);
} else {
allMaps = true;
}stddev = this.e.getSmilesExt ().getSmilesCorrelation (bs1, bs2, pattern, ptsA, ptsB, m, null, isMap, null, null, bestMap, (isSmiles ? 65536 : 131072) | (!allMaps && !bestMap ? 4194304 : 0));
if (isMap) {
...
var isON = !isList && args.length > 0 && (args[args.length - 1].tok == 1048589);
try {
if (isChemical) {
...
try {
ret = this.e.getSmilesExt ().getSmilesMatches (pattern, smiles, null, null, isSMARTS, !asMap, !allMappings);
} catch (e) {
if (Clazz_exceptionOf (e, Exception)) {
return mp.addXInt (-1);
} else {
...
sFind = (args.length > 1 && args[1].tok == 10 ? this.vwr.getSmilesOpt (args[1].value, 0, 0, 0) : flags);
}var bsMatch3D = bs2;
if (asBonds) {
...
if (x.tok == 7 && tok != 1276117512 && (tok != 1276118023 || args.length == 2)) {
mp.addX (x);
return this.evaluateList (mp, tok, args);
}var s = (tok == 1276118023 && x.tok == 10 || tok == 1276117512 && x.tok == 7 ? null : JS.SV.sValue (x));
switch (tok) {
case 1276118023:
if (x.tok == 10) {
