...
(x=q?d[n]:d[n].data)){f.isArray(a)?a=a.concat(f.map(a,f.camelCase)):a in x?a=[a]:(a=f.camelCase(a),a=a in x?[a]:a.split(" "));for(j=a.length;j--;)delete x[a[j]];if(q?!b(x):!f.isEmptyObject(x))return}if(!q&&(delete d[n].data,!b(d[n])))return;c?f.cleanData([g],!0):u.deleteExpando||d!=d.window?delete d[n]:d[n]=null}}}function s(){return!0}function C(){return!1}function E(){try{return y.activeElement}catch(g){}}function S(g){var a=mc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
return g}function L(g,a){var q,x,b=0,j=typeof g.getElementsByTagName!==ja?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==ja?g.querySelectorAll(a||"*"):void 0;if(!j){j=[];for(q=g.childNodes||g;null!=(x=q[b]);b++)!a||f.nodeName(x,a)?j.push(x):f.merge(j,L(x,a))}return void 0===a||a&&f.nodeName(g,a)?f.merge([g],j):j}function sb(g){Ob.test(g.type)&&(g.defaultChecked=g.checked)}function Ma(g,a){return f.nodeName(g,"table")&&f.nodeName(11!==a.nodeType?a:a.firstChild,"tr")?g.getElementsByTagName("tbody")[0]||
g.appendChild(g.ownerDocument.createElement("tbody")):g}function V(g){g.type=(null!==f.find.attr(g,"type"))+"/"+g.type;return g}function D(g){var a=Zc.exec(g.type);a?g.type=a[1]:g.removeAttribute("type");return g}function Wa(g,a){for(var q,x=0;null!=(q=g[x]);x++)f._data(q,"globalEval",!a||f._data(a[x],"globalEval"))}function Aa(g,a){if(1===a.nodeType&&f.hasData(g)){var q,x,b;x=f._data(g);var j=f._data(a,x),c=x.events;if(c)for(q in delete j.handle,j.events={},c){x=0;for(b=c[q].length;x<b;x++)f.event.add(a,
...
j(n),!1;if(d)return!(p=n)});return p}var c={},d=g===Pb;return j(a.dataTypes[0])||!c["*"]&&j("*")}function ma(g,a){var q,b,j=f.ajaxSettings.flatOptions||{};for(b in a)void 0!==a[b]&&((j[b]?g:q||(q={}))[b]=a[b]);q&&f.extend(!0,g,q);return g}function B(g,a,q,b){var j;if(f.isArray(a))f.each(a,function(a,v){q||bd.test(g)?b(g,v):B(g+"["+("object"===typeof v?a:"")+"]",v,q,b)});else if(!q&&"object"===f.type(a))for(j in a)B(g+"["+j+"]",a[j],q,b);else b(g,a)}function U(g){try{return g?new a.ActiveXObject("Microsoft.XMLHTTP"):
new a.XMLHttpRequest}catch(v){}}function aa(){try{return new a.XMLHttpRequest}catch(g){}}function j(g){return f.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var n=[],p=n.slice,z=n.concat,H=n.push,I=n.indexOf,fa={},Qb=fa.toString,Ya=fa.hasOwnProperty,Rb="".trim,u={},f=function(g,a){return new f.fn.init(g,a)},cd=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,dd=/^-ms-/,ed=/-([\da-z])/gi,fd=function(g,a){return a.toUpperCase()};f.fn=f.prototype={jquery:"1.11.0",constructor:f,selector:"",length:0,
...
f.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){fa["[object "+a+"]"]=a.toLowerCase()});var O=a,K=function(g,a,q,b){var f,j,c,d,n;(a?a.ownerDocument||a:W)!==R&&na(a);a=a||R;q=q||[];if(!g||"string"!==typeof g)return q;if(1!==(d=a.nodeType)&&9!==d)return[];if(ba&&!b){if(f=gd.exec(g))if(c=f[1])if(9===d)if((j=a.getElementById(c))&&j.parentNode){if(j.id===c)return q.push(j),q}else return q;else{if(a.ownerDocument&&(j=a.ownerDocument.getElementById(c))&&wa(a,
j)&&j.id===c)return q.push(j),q}else{if(f[2])return Da.apply(q,a.getElementsByTagName(g)),q;if((c=f[3])&&F.getElementsByClassName&&a.getElementsByClassName)return Da.apply(q,a.getElementsByClassName(c)),q}if(F.qsa&&(!Q||!Q.test(g))){j=f=N;c=a;n=9===d&&g;if(1===d&&"object"!==a.nodeName.toLowerCase()){d=sa(g);(f=a.getAttribute("id"))?j=f.replace(hd,"\\$&"):a.setAttribute("id",j);j="[id='"+j+"'] ";for(c=d.length;c--;)d[c]=j+wb(d[c]);c=Sb.test(g)&&ga(a.parentNode)||a;n=d.join(",")}if(n)try{return Da.apply(q,
c.querySelectorAll(n)),q}catch(p){}finally{f||a.removeAttribute("id")}}}var h;a:{g=g.replace(xb,"$1");j=sa(g);if(!b&&1===j.length){f=j[0]=j[0].slice(0);if(2<f.length&&"ID"===(h=f[0]).type&&F.getById&&9===a.nodeType&&ba&&G.relative[f[1].type]){a=(G.find.ID(h.matches[0].replace(Ea,Fa),a)||[])[0];if(!a){h=q;break a}g=g.slice(f.shift().value.length)}for(d=yb.needsContext.test(g)?0:f.length;d--;){h=f[d];if(G.relative[c=h.type])break;if(c=G.find[c])if(b=c(h.matches[0].replace(Ea,Fa),Sb.test(f[0].type)&&
ga(a.parentNode)||a)){f.splice(d,1);g=b.length&&wb(f);if(!g){Da.apply(q,b);h=q;break a}break}}}Za(g,j)(b,a,!ba,q,Sb.test(g)&&ga(a.parentNode)||a);h=q}return h},Tb=function(){function g(q,b){a.push(q+" ")>G.cacheLength&&delete g[a.shift()];return g[q+" "]=b}var a=[];return g},oa=function(g){g[N]=!0;return g},X=function(g){var a=R.createElement("div");try{return!!g(a)}catch(q){return!1}finally{a.parentNode&&a.parentNode.removeChild(a)}},Ub=function(g,a){for(var q=g.split("|"),b=g.length;b--;)G.attrHandle[q[b]]=
...
j[c]])q[f]=!(b[f]=q[f])})})},ga=function(g){return g&&typeof g.getElementsByTagName!==A&&g},qc=function(){},sa=function(g,a){var q,b,f,j,c,d,n;if(c=rc[g+" "])return a?0:c.slice(0);c=g;d=[];for(n=G.preFilter;c;){if(!q||(b=kd.exec(c)))b&&(c=c.slice(b[0].length)||c),d.push(f=[]);q=!1;if(b=ld.exec(c))q=b.shift(),f.push({value:q,type:b[0].replace(xb," ")}),c=c.slice(q.length);for(j in G.filter)if((b=yb[j].exec(c))&&(!n[j]||(b=n[j](b))))q=b.shift(),f.push({value:q,type:j,matches:b}),c=c.slice(q.length);
if(!q)break}return a?c.length:c?K.error(g):rc(g,d).slice(0)},wb=function(g){for(var a=0,q=g.length,b="";a<q;a++)b+=g[a].value;return b},Vb=function(g,a,q){var b=a.dir,f=q&&"parentNode"===b,j=md++;return a.first?function(a,q,v){for(;a=a[b];)if(1===a.nodeType||f)return g(a,q,v)}:function(a,q,v){var c,d,n=[Y,j];if(v)for(;a=a[b];){if((1===a.nodeType||f)&&g(a,q,v))return!0}else for(;a=a[b];)if(1===a.nodeType||f){d=a[N]||(a[N]={});if((c=d[b])&&c[0]===Y&&c[1]===j)return n[2]=c[2];d[b]=n;if(n[2]=g(a,q,v))return!0}}},
Wb=function(g){return 1<g.length?function(a,q,b){for(var f=g.length;f--;)if(!g[f](a,q,b))return!1;return!0}:g[0]},zb=function(g,a,q,b,f){for(var j,c=[],d=0,n=g.length,p=null!=a;d<n;d++)if(j=g[d])if(!q||q(j,b,f))c.push(j),p&&a.push(d);return c},$a=function(g,a,q,b,f,j){b&&!b[N]&&(b=$a(b));f&&!f[N]&&(f=$a(f,j));return oa(function(j,c,d,n){var p,h,ea=[],s=[],e=c.length,l;if(!(l=j)){l=a||"*";for(var k=d.nodeType?[d]:d,A=[],z=0,C=k.length;z<C;z++)K(l,k[z],A);l=A}l=g&&(j||!a)?zb(l,ea,g,d,n):l;k=q?f||(j?
g:e||b)?[]:c:l;q&&q(l,k,d,n);if(b){p=zb(k,s);b(p,[],d,n);for(d=p.length;d--;)if(h=p[d])k[s[d]]=!(l[s[d]]=h)}if(j){if(f||g){if(f){p=[];for(d=k.length;d--;)if(h=k[d])p.push(l[d]=h);f(null,k=[],p,n)}for(d=k.length;d--;)if((h=k[d])&&-1<(p=f?Sa.call(j,h):ea[d]))j[p]=!(c[p]=h)}}else k=zb(k===c?k.splice(e,k.length):k),f?f(null,c,k,n):Da.apply(c,k)})},ab=function(g){var a,q,b,f=g.length,j=G.relative[g[0].type];q=j||G.relative[" "];for(var c=j?1:0,d=Vb(function(g){return g===a},q,!0),n=Vb(function(g){return-1<
Sa.call(a,g)},q,!0),p=[function(g,q,b){return!j&&(b||q!==xa)||((a=q).nodeType?d(g,q,b):n(g,q,b))}];c<f;c++)if(q=G.relative[g[c].type])p=[Vb(Wb(p),q)];else{q=G.filter[g[c].type].apply(null,g[c].matches);if(q[N]){for(b=++c;b<f&&!G.relative[g[b].type];b++);return $a(1<c&&Wb(p),1<c&&wb(g.slice(0,c-1).concat({value:" "===g[c-2].type?"*":""})).replace(xb,"$1"),q,c<b&&ab(g.slice(c,b)),b<f&&ab(g=g.slice(b)),b<f&&wb(g))}p.push(q)}return Wb(p)},ya,F,G,Ha,sc,Za,xa,pa,za,na,R,ca,ba,Q,ha,ta,wa,N="sizzle"+-new Date,
W=O.document,Y=0,md=0,tc=Tb(),rc=Tb(),Ia=Tb(),ua=function(g,a){g===a&&(za=!0);return 0},A="undefined",Ga=-2147483648,da={}.hasOwnProperty,P=[],qa=P.pop,bb=P.push,Da=P.push,uc=P.slice,Sa=P.indexOf||function(g){for(var a=0,q=this.length;a<q;a++)if(this[a]===g)return a;return-1},vc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),wc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+vc+")|)|)[\\x20\\t\\r\\n\\f]*\\]",
...
"i")},qd=/^(?:input|select|textarea|button)$/i,rd=/^h\d$/i,mb=/^[^{]+\{\s*\[native \w/,gd=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Sb=/[+~]/,hd=/'|\\/g,Ea=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),Fa=function(g,a,q){g="0x"+a-65536;return g!==g||q?a:0>g?String.fromCharCode(g+65536):String.fromCharCode(g>>10|55296,g&1023|56320)};try{Da.apply(P=uc.call(W.childNodes),W.childNodes),P[W.childNodes.length].nodeType}catch(Yd){Da={apply:P.length?function(g,a){bb.apply(g,uc.call(a))}:
function(g,a){for(var q=g.length,b=0;g[q++]=a[b++];);g.length=q-1}}}F=K.support={};sc=K.isXML=function(g){return(g=g&&(g.ownerDocument||g).documentElement)?"HTML"!==g.nodeName:!1};na=K.setDocument=function(g){var a=g?g.ownerDocument||g:W;g=a.defaultView;if(a===R||9!==a.nodeType||!a.documentElement)return R;R=a;ca=a.documentElement;ba=!sc(a);g&&g!==g.top&&(g.addEventListener?g.addEventListener("unload",function(){na()},!1):g.attachEvent&&g.attachEvent("onunload",function(){na()}));F.attributes=X(function(g){g.className=
"i";return!g.getAttribute("className")});F.getElementsByTagName=X(function(g){g.appendChild(a.createComment(""));return!g.getElementsByTagName("*").length});F.getElementsByClassName=mb.test(a.getElementsByClassName)&&X(function(g){g.innerHTML="<div class='a'></div><div class='a i'></div>";g.firstChild.className="i";return 2===g.getElementsByClassName("i").length});F.getById=X(function(g){ca.appendChild(g).id=N;return!a.getElementsByName||!a.getElementsByName(N).length});F.getById?(G.find.ID=function(g,
a){if(typeof a.getElementById!==A&&ba){var b=a.getElementById(g);return b&&b.parentNode?[b]:[]}},G.filter.ID=function(g){var a=g.replace(Ea,Fa);return function(g){return g.getAttribute("id")===a}}):(delete G.find.ID,G.filter.ID=function(g){var a=g.replace(Ea,Fa);return function(g){return(g=typeof g.getAttributeNode!==A&&g.getAttributeNode("id"))&&g.value===a}});G.find.TAG=F.getElementsByTagName?function(g,a){if(typeof a.getElementsByTagName!==A)return a.getElementsByTagName(g)}:function(g,a){var b,
v=[],f=0,j=a.getElementsByTagName(g);if("*"===g){for(;b=j[f++];)1===b.nodeType&&v.push(b);return v}return j};G.find.CLASS=F.getElementsByClassName&&function(g,a){if(typeof a.getElementsByClassName!==A&&ba)return a.getElementsByClassName(g)};ha=[];Q=[];if(F.qsa=mb.test(a.querySelectorAll))X(function(g){g.innerHTML="<select t=''><option selected=''></option></select>";g.querySelectorAll("[t^='']").length&&Q.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");g.querySelectorAll("[selected]").length||Q.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
g.querySelectorAll(":checked").length||Q.push(":checked")}),X(function(g){var b=a.createElement("input");b.setAttribute("type","hidden");g.appendChild(b).setAttribute("name","D");g.querySelectorAll("[name=d]").length&&Q.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");g.querySelectorAll(":enabled").length||Q.push(":enabled",":disabled");g.querySelectorAll("*,:x");Q.push(",.*:")});(F.matchesSelector=mb.test(ta=ca.webkitMatchesSelector||ca.mozMatchesSelector||ca.oMatchesSelector||ca.msMatchesSelector))&&
X(function(g){F.disconnectedMatch=ta.call(g,"div");ta.call(g,"[s!='']:x");ha.push("!=",Xb)});Q=Q.length&&RegExp(Q.join("|"));ha=ha.length&&RegExp(ha.join("|"));wa=(g=mb.test(ca.compareDocumentPosition))||mb.test(ca.contains)?function(g,a){var b=9===g.nodeType?g.documentElement:g,v=a&&a.parentNode;return g===v||!(!v||!(1===v.nodeType&&(b.contains?b.contains(v):g.compareDocumentPosition&&g.compareDocumentPosition(v)&16)))}:function(g,a){if(a)for(;a=a.parentNode;)if(a===g)return!0;return!1};ua=g?function(g,
b){if(g===b)return za=!0,0;var f=!g.compareDocumentPosition-!b.compareDocumentPosition;if(f)return f;f=(g.ownerDocument||g)===(b.ownerDocument||b)?g.compareDocumentPosition(b):1;return f&1||!F.sortDetached&&b.compareDocumentPosition(g)===f?g===a||g.ownerDocument===W&&wa(W,g)?-1:b===a||b.ownerDocument===W&&wa(W,b)?1:pa?Sa.call(pa,g)-Sa.call(pa,b):0:f&4?-1:1}:function(g,b){if(g===b)return za=!0,0;var f,j=0;f=g.parentNode;var c=b.parentNode,d=[g],n=[b];if(!f||!c)return g===a?-1:b===a?1:f?-1:c?1:pa?Sa.call(pa,
g)-Sa.call(pa,b):0;if(f===c)return pc(g,b);for(f=g;f=f.parentNode;)d.unshift(f);for(f=b;f=f.parentNode;)n.unshift(f);for(;d[j]===n[j];)j++;return j?pc(d[j],n[j]):d[j]===W?-1:n[j]===W?1:0};return a};K.matches=function(g,a){return K(g,null,null,a)};K.matchesSelector=function(g,a){(g.ownerDocument||g)!==R&&na(g);a=a.replace(nd,"='$1']");if(F.matchesSelector&&ba&&(!ha||!ha.test(a))&&(!Q||!Q.test(a)))try{var b=ta.call(g,a);if(b||F.disconnectedMatch||g.document&&11!==g.document.nodeType)return b}catch(f){}return 0<
K(a,R,null,[g]).length};K.contains=function(g,a){(g.ownerDocument||g)!==R&&na(g);return wa(g,a)};K.attr=function(g,a){(g.ownerDocument||g)!==R&&na(g);var b=G.attrHandle[a.toLowerCase()],b=b&&da.call(G.attrHandle,a.toLowerCase())?b(g,a,!ba):void 0;return void 0!==b?b:F.attributes||!ba?g.getAttribute(a):(b=g.getAttributeNode(a))&&b.specified?b.value:null};K.error=function(g){throw Error("Syntax error, unrecognized expression: "+g);};K.uniqueSort=function(g){var a,b=[],f=0,j=0;za=!F.detectDuplicates;
pa=!F.sortStable&&g.slice(0);g.sort(ua);if(za){for(;a=g[j++];)a===g[j]&&(f=b.push(j));for(;f--;)g.splice(b[f],1)}pa=null;return g};Ha=K.getText=function(g){var a,b="",f=0;if(a=g.nodeType)if(1===a||9===a||11===a){if("string"===typeof g.textContent)return g.textContent;for(g=g.firstChild;g;g=g.nextSibling)b+=Ha(g)}else{if(3===a||4===a)return g.nodeValue}else for(;a=g[f++];)b+=Ha(a);return b};G=K.selectors={cacheLength:50,createPseudo:oa,match:yb,attrHandle:{},find:{},relative:{">":{dir:"parentNode",
first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(g){g[1]=g[1].replace(Ea,Fa);g[3]=(g[4]||g[5]||"").replace(Ea,Fa);"~="===g[2]&&(g[3]=" "+g[3]+" ");return g.slice(0,4)},CHILD:function(g){g[1]=g[1].toLowerCase();"nth"===g[1].slice(0,3)?(g[3]||K.error(g[0]),g[4]=+(g[4]?g[5]+(g[6]||1):2*("even"===g[3]||"odd"===g[3])),g[5]=+(g[7]+g[8]||"odd"===g[3])):g[3]&&K.error(g[0]);return g},PSEUDO:function(g){var a,b=!g[5]&&g[2];if(yb.CHILD.test(g[0]))return null;
...
function(a,b,q){var v,p,h,s,k;b=c!==d?"nextSibling":"previousSibling";var l=a.parentNode,e=n&&a.nodeName.toLowerCase();q=!q&&!n;if(l){if(c){for(;b;){for(p=a;p=p[b];)if(n?p.nodeName.toLowerCase()===e:1===p.nodeType)return!1;k=b="only"===g&&!k&&"nextSibling"}return!0}k=[d?l.firstChild:l.lastChild];if(d&&q){q=l[N]||(l[N]={});v=q[g]||[];s=v[0]===Y&&v[1];h=v[0]===Y&&v[2];for(p=s&&l.childNodes[s];p=++s&&p&&p[b]||(h=s=0)||k.pop();)if(1===p.nodeType&&++h&&p===a){q[g]=[Y,s,h];break}}else if(q&&(v=(a[N]||(a[N]=
{}))[g])&&v[0]===Y)h=v[1];else for(;p=++s&&p&&p[b]||(h=s=0)||k.pop();)if((n?p.nodeName.toLowerCase()===e:1===p.nodeType)&&++h)if(q&&((p[N]||(p[N]={}))[g]=[Y,h]),p===a)break;h-=j;return h===f||0===h%f&&0<=h/f}}},PSEUDO:function(g,a){var b,f=G.pseudos[g]||G.setFilters[g.toLowerCase()]||K.error("unsupported pseudo: "+g);return f[N]?f(a):1<f.length?(b=[g,g,"",a],G.setFilters.hasOwnProperty(g.toLowerCase())?oa(function(g,b){for(var q,j=f(g,a),c=j.length;c--;)q=Sa.call(g,j[c]),g[q]=!(b[q]=j[c])}):function(g){return f(g,
0,b)}):f}},pseudos:{not:oa(function(g){var a=[],b=[],f=Za(g.replace(xb,"$1"));return f[N]?oa(function(g,a,b,q){q=f(g,null,q,[]);for(var v=g.length;v--;)if(b=q[v])g[v]=!(a[v]=b)}):function(g,j,c){a[0]=g;f(a,null,c,b);return!b.pop()}}),has:oa(function(g){return function(a){return 0<K(g,a).length}}),contains:oa(function(g){return function(a){return-1<(a.textContent||a.innerText||Ha(a)).indexOf(g)}}),lang:oa(function(g){pd.test(g||"")||K.error("unsupported lang: "+g);g=g.replace(Ea,Fa).toLowerCase();
return function(a){var b;do if(b=ba?a.lang:a.getAttribute("xml:lang")||a.getAttribute("lang"))return b=b.toLowerCase(),b===g||0===b.indexOf(g+"-");while((a=a.parentNode)&&1===a.nodeType);return!1}}),target:function(g){var a=O.location&&O.location.hash;return a&&a.slice(1)===g.id},root:function(g){return g===ca},focus:function(g){return g===R.activeElement&&(!R.hasFocus||R.hasFocus())&&!(!g.type&&!g.href&&!~g.tabIndex)},enabled:function(g){return!1===g.disabled},disabled:function(g){return!0===g.disabled},
...
b+a:b;++b<a;)g.push(b);return g})}};G.pseudos.nth=G.pseudos.eq;for(ya in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})G.pseudos[ya]=id(ya);for(ya in{submit:!0,reset:!0})G.pseudos[ya]=jd(ya);qc.prototype=G.filters=G.pseudos;G.setFilters=new qc;Za=K.compile=function(g,a){var b,f=[],j=[],c=Ia[g+" "];if(!c){a||(a=sa(g));for(b=a.length;b--;)c=ab(a[b]),c[N]?f.push(c):j.push(c);var d=0<f.length,n=0<j.length;b=function(g,a,b,q,v){var c,p,h,s=0,ea="0",l=g&&[],k=[],e=xa,A=g||n&&G.find.TAG("*",v),z=Y+=
null==e?1:Math.random()||0.1,C=A.length;for(v&&(xa=a!==R&&a);ea!==C&&null!=(c=A[ea]);ea++){if(n&&c){for(p=0;h=j[p++];)if(h(c,a,b)){q.push(c);break}v&&(Y=z)}d&&((c=!h&&c)&&s--,g&&l.push(c))}s+=ea;if(d&&ea!==s){for(p=0;h=f[p++];)h(l,k,a,b);if(g){if(0<s)for(;ea--;)!l[ea]&&!k[ea]&&(k[ea]=qa.call(q));k=zb(k)}Da.apply(q,k);v&&(!g&&0<k.length&&1<s+f.length)&&K.uniqueSort(q)}v&&(Y=z,xa=e);return l};b=d?oa(b):b;c=Ia(g,b)}return c};F.sortStable=N.split("").sort(ua).join("")===N;F.detectDuplicates=!!za;na();
F.sortDetached=X(function(g){return g.compareDocumentPosition(R.createElement("div"))&1});X(function(g){g.innerHTML="<a href='#'></a>";return"#"===g.firstChild.getAttribute("href")})||Ub("type|href|height|width",function(g,a,b){if(!b)return g.getAttribute(a,"type"===a.toLowerCase()?1:2)});(!F.attributes||!X(function(g){g.innerHTML="<input/>";g.firstChild.setAttribute("value","");return""===g.firstChild.getAttribute("value")}))&&Ub("value",function(g,a,b){if(!b&&"input"===g.nodeName.toLowerCase())return g.defaultValue});
...
f&&f.clientLeft||0),a.pageY=b.clientY+(j&&j.scrollTop||f&&f.scrollTop||0)-(j&&j.clientTop||f&&f.clientTop||0));!a.relatedTarget&&d&&(a.relatedTarget=d===a.target?b.toElement:d);!a.which&&void 0!==c&&(a.which=c&1?1:c&2?3:c&4?2:0);return a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==E()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){if(this===E()&&this.blur)return this.blur(),!1},delegateType:"focusout"},click:{trigger:function(){if(f.nodeName(this,
...
S(y).appendChild(y.createElement("div"));ia.optgroup=ia.option;ia.tbody=ia.tfoot=ia.colgroup=ia.caption=ia.thead;ia.th=ia.td;f.extend({clone:function(a,b,j){var c,d,n,p,h,s=f.contains(a.ownerDocument,a);u.html5Clone||f.isXMLDoc(a)||!Ec.test("<"+a.nodeName+">")?n=a.cloneNode(!0):(ac.innerHTML=a.outerHTML,ac.removeChild(n=ac.firstChild));if((!u.noCloneEvent||!u.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!f.isXMLDoc(a)){c=L(n);h=L(a);for(p=0;null!=(d=h[p]);++p)if(c[p]){var k=c[p],e=void 0,l=
void 0,A=void 0;if(1===k.nodeType){e=k.nodeName.toLowerCase();if(!u.noCloneEvent&&k[f.expando]){A=f._data(k);for(l in A.events)f.removeEvent(k,l,A.handle);k.removeAttribute(f.expando)}if("script"===e&&k.text!==d.text)V(k).text=d.text,D(k);else if("object"===e)k.parentNode&&(k.outerHTML=d.outerHTML),u.html5Clone&&(d.innerHTML&&!f.trim(k.innerHTML))&&(k.innerHTML=d.innerHTML);else if("input"===e&&Ob.test(d.type))k.defaultChecked=k.checked=d.checked,k.value!==d.value&&(k.value=d.value);else if("option"===
e)k.defaultSelected=k.selected=d.defaultSelected;else if("input"===e||"textarea"===e)k.defaultValue=d.defaultValue}}}if(b)if(j){h=h||L(a);c=c||L(n);for(p=0;null!=(d=h[p]);p++)Aa(d,c[p])}else Aa(a,n);c=L(n,"script");0<c.length&&Wa(c,!s&&L(a,"script"));return n},buildFragment:function(a,b,j,c){for(var d,n,p,h,s,k,e=a.length,l=S(b),A=[],z=0;z<e;z++)if((n=a[z])||0===n)if("object"===f.type(n))f.merge(A,n.nodeType?[n]:n);else if(zd.test(n)){p=p||l.appendChild(b.createElement("div"));h=(Gc.exec(n)||["",
...
g,b){var j,c={},d=0;if(f.isArray(g)){b=Pa(a);for(j=g.length;d<j;d++)c[g[d]]=f.css(a,g[d],!1,b);return c}return void 0!==b?f.style(a,g,b):f.css(a,g)},a,b,1<arguments.length)},show:function(){return gb(this,!0)},hide:function(){return gb(this)},toggle:function(a){return"boolean"===typeof a?a?this.show():this.hide():this.each(function(){hb(this)?f(this).show():f(this).hide()})}});f.Tween=M;M.prototype={constructor:M,init:function(a,b,j,c,d,n){this.elem=a;this.prop=j;this.easing=d||"swing";this.options=
b;this.start=this.now=this.cur();this.end=c;this.unit=n||(f.cssNumber[j]?"":"px")},cur:function(){var a=M.propHooks[this.prop];return a&&a.get?a.get(this):M.propHooks._default.get(this)},run:function(a){var b,j=M.propHooks[this.prop];this.pos=this.options.duration?b=f.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):b=a;this.now=(this.end-this.start)*b+this.start;this.options.step&&this.options.step.call(this.elem,this.now,this);j&&j.set?j.set(this):M.propHooks._default.set(this);
return this}};M.prototype.init.prototype=M.prototype;M.propHooks={_default:{get:function(a){if(null!=a.elem[a.prop]&&(!a.elem.style||null==a.elem.style[a.prop]))return a.elem[a.prop];a=f.css(a.elem,a.prop,"");return!a||"auto"===a?0:a},set:function(a){if(f.fx.step[a.prop])f.fx.step[a.prop](a);else a.elem.style&&(null!=a.elem.style[f.cssProps[a.prop]]||f.cssHooks[a.prop])?f.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};M.propHooks.scrollTop=M.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&
a.elem.parentNode&&(a.elem[a.prop]=a.now)}};f.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};f.fx=M.prototype.init;f.fx.step={};var Xa,Jb,Id=/^(?:toggle|show|hide)$/,Lc=RegExp("^(?:([+-])=|)("+Bb+")([a-z%]*)$","i"),Jd=/queueHooks$/,ub=[function(a,b,j){var c,d,n,p,h,s,k=this,e={},l=a.style,A=a.nodeType&&hb(a),z=f._data(a,"fxshow");j.queue||(p=f._queueHooks(a,"fx"),null==p.unqueued&&(p.unqueued=0,h=p.empty.fire,p.empty.fire=function(){p.unqueued||h()}),p.unqueued++,
...
e.timeout));try{da=1,k.send(m,j)}catch(E){if(2>da)j(-1,E);else throw E;}}else j(-1,"No Transport");return r},getJSON:function(a,b,j){return f.get(a,b,j,"json")},getScript:function(a,b){return f.get(a,void 0,b,"script")}});f.each(["get","post"],function(a,b){f[b]=function(a,j,g,c){f.isFunction(j)&&(c=c||g,g=j,j=void 0);return f.ajax({url:a,type:b,dataType:c,data:j,success:g})}});f.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){f.fn[b]=function(a){return this.on(b,
...
t.responseText:null}catch(s){}try{h.binary=t.response}catch(m){}try{c=t.statusText}catch(r){c=""}!b&&a.isLocal&&!a.crossDomain?b=h.text?200:404:1223===b&&(b=204);l(b,c,h,d)}}catch(D){alert(D),l(-1,D)}};a.async?4===t.readyState?setTimeout(e):t.onreadystatechange=e:e()},abort:function(){}}}))})(jQuery);
...
Jmol._version||(Jmol=function(a){var m=function(a){return{rear:a++,header:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,console:a+91E3,consoleImage:a+91001,monitorZIndex:a+99999}},m={_version:"$Date: 2015-08-22 00:07:01 -0500 (Sat, 22 Aug 2015) $",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_appletCssClass:"",_appletCssText:"",_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_persistentMenu:!1,
...
t=a._isDirectCall(b),r=!l&&a.$supportsIECrossDomainScripting(),V=null;if(m||k||!l&&!t||!d&&r)V=a._getRawDataFromServer("_",b,d,d,k,!0);else{b=b.replace(/file:\/\/\/\//,"file://");var D={dataType:h?"binary":"text",async:!!d};e?(D.type="POST",D.url=b.split("?POST?")[0],D.data=b.split("?POST?")[1]):(D.type="GET",D.url=b);d&&(D.success=function(){d(a._xhrReturn(D.xhr))},D.error=function(){d(D.xhr.statusText)});D.xhr=a.$ajax(D);d||(V=a._xhrReturn(D.xhr))}if(!c)return V;null==V&&(V="",h=!1);h&&(h=a._canSyncBinary(!0));
...
m);l.src="string"==typeof e?e:"data:"+JU.Rdr.guessMimeTypeForBytes(e)+";base64,"+JU.Base64.getBase64(e)}var r=l.width,D=l.height;"webgl"==d&&(r/=2,D/=2);t=a._getHiddenCanvas(b.vwr.html5Applet,m,r,D,!0,!1);t.imageWidth=r;t.imageHeight=D;t.id=m;t.image=l;a._setCanvasImage(t,r,D,l.width,l.height)}else System.out.println("Jsmol.js Jmol._loadImage reading cached image for "+m);return null==e?k(t,h):t};a._canvasCache={};a._getHiddenCanvas=function(b,d,h,e,k,l){d=b._id+"_"+d;b=a._canvasCache[d];if(l)return b;
...
c;try{null.hello()}catch(s){if(l=function(a,b,c){c||(c="[^\\s]+");var d=a.indexOf(b);a=a.substring(0,d)+c+a.substring(d+b.length);return RegExp("^"+a+"$")},/Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)){var l=s.message.indexOf(":"),C=s.message.indexOf(":",l+2),E=s.message.substr(l+1,C-l-20);c=function(a){return-1!=a.message.indexOf(E)}}else if(-1!=navigator.userAgent.toLowerCase().indexOf("webkit")){var S=l(s.message,"hello");c=function(a){return S.test(a.message)}}else S=l(s.message,"$$o$$"),
...
L(b,c,e);d.funParams=e;d.claxxOwner=b;return b.prototype[c]=d};var D="";a.getProfile=function(){var a="";if(h){var a=[],b;for(b in h){var c=""+h[b];a.push("        ".substring(c.length)+c+"\t"+b)}a=a.sort().reverse().join("\r\n");h={}}return a+D};a.getParamsType=function(b){var c=b.length;switch(c){case 0:var d=["void"];d.typeString="\\void";return d;case 1:switch(typeof obj){case "number":return d=["n"],d.typeString="\\n",d;case "boolean":return d=["b"],d.typeString="\\b",d}}d=[];d.hasCastedNull=
...
null,a.lastParams=null,a.lastClaxxRef=null)}}a._Loader=a.ClazzLoader=function(){};var w=function(){this.parents=[];this.musts=[];this.optionals=[];this.onLoaded=this.path=this.name=this.declaration=null;this.status=0;this.random=0.13412};(function(a,b){b._checkLoad=m._checkLoad;b.updateNodeForFunctionDecoration=function(a){(a=F(a))&&a.status==w.STATUS_KNOWN&&window.setTimeout(function(a){return function(){updateNode(a)}}(a),1)};w.prototype.toString=function(){return this.name||this.path||"ClazzNode"};
...
f&&(k=6)}var B;self.Clazz&&a.isClassDefined?isClassDefined=a.isClassDefined:(B={},isClassDefined=function(a){return!0==B[a]});var E=function(a){if(!a||0==a.length)return[];for(var b=null,c=0;c<a.length;c++)if(a[c]){if("$"==a[c].charAt(0))if("."==a[c].charAt(1)){if(!b)continue;var d=b.lastIndexOf(".");-1!=d&&(b=b.substring(0,d),a[c]=b+a[c].substring(1))}else a[c]="org.eclipse.s"+a[c].substring(1);b=a[c]}return a},D=[],O={},K=0;b.loadPackageClasspath=function(a,c,d,e,f,h){f||(f=0);e||(e=null);h||(h=
0);var j=d&&O["@"+a];if(0==f&&(d&&!O["@java"]&&0!=a.indexOf("java")&&M("java"))&&(b.loadPackage("java",e?function(){b.loadPackageClasspath(a,c,d,e,1)}:null),e))return;if(a instanceof Array)if(E(a),e)h<a.length?b.loadPackageClasspath(a[h],c,d,function(){b.loadPackageClasspath(a,c,d,e,1,h+1)},1):e();else for(j=0;j<a.length;j++)b.loadPackageClasspath(a[j],c,d,null);else{switch(a){case "java.*":a="java";case "java":c&&(f="@net.sf.j2s.ajax",O[f]||(O[f]=c),f="@net.sf.j2s",O[f]||(O[f]=c));break;case "swt":a=
"org.eclipse.swt";break;case "ajax":a="net.sf.j2s.ajax";break;case "j2s":a="net.sf.j2s";break;default:a.lastIndexOf(".*")==a.length-2&&(a=a.substring(0,a.length-2))}c&&(O["@"+a]=c);d&&!j&&!window[a+".registered"]?(K++,"java"==a&&(a="core"),b.loadClass(a+".package",function(){0==--K&&Ba()},!0,!0,1)):e&&e()}};a.loadClass=function(c,d,e){self.Class||(Class=a,Class.forName=a._4Name,JavaObject=a._O);return c&&b.loadClass(c,d,!0,e,1)};b.loadClass=function(c,f,h,k,l){l||(l=0);null==k&&(k=!1);if("boolean"==
typeof f)return a.evalType(c);System.out.println("loadClass "+c);M("java")&&b.loadPackage("java");M("core")&&b.loadPackage("core");b.keepOnLoading=!0;if(!h&&(K&&c.lastIndexOf(".package")!=c.length-8||0!=c.indexOf("java.")&&!isClassDefined(ta)))wa.push([c,f]),System.out.println("loadclass-queuing"+c+ta+" "+isClassDefined(ta));else if((l=isClassDefined(c))||X["@"+c]){if(l&&f&&(h=F(c),!h||h.status>=w.STATUS_LOAD_COMPLETE))k?window.setTimeout(f,25):f()}else{var m=b.getClasspathFor(c);l=e[m];if(!l)for(k=
D.length;0<=--k;)if(D[k].path==m||D[k].name==c){l=!0;break}if(l){if(f&&(l=F(c)))if(l.onLoaded){if(f!=l.onLoaded){var p=l.onLoaded,r=f;l.onLoaded=function(){p();r()}}}else l.onLoaded=f}else{l=a.unloadedClasses[c]&&F(c)||new w;l.name=c;l.path=m;l.isPackage=m.lastIndexOf("package.js")==m.length-10;Q(m,c,l);l.onLoaded=f;l.status=w.STATUS_KNOWN;c=!1;for(k=D.length;0<=--k;)if(D[k].status!=w.STATUS_LOAD_COMPLETE){c=!0;break}if(l.isPackage){for(k=D.length;0<=--k&&!D[k].isPackage;)D[k+1]=D[k];D[++k]=l}else c&&
D.push(l);if(!c){var s=!1;f&&(s=ga,ga=!0);h&&(f=null);Ia(d,l,!0);U(l,l.path,l.requiredBy,!1,f?function(){ga=s;f()}:null)}}}};var M=function(a){return null!=window[a+".registered"]&&!O["@"+a]};b.loadPackage=function(a,c){c||(c=null);window[a+".registered"]=!1;b.loadPackageClasspath(a,b.J2SLibBase||(b.J2SLibBase=b.getJ2SLibBase()||"j2s/"),!0,c)};b.jarClasspath=function(a,b){b instanceof Array||(b=[classes]);E(b);for(var c=b.length;0<=--c;)O["#"+b[c]]=a;O["$"+a]=b};b.registerPackages=function(c,d){for(var e=
b.getClasspathFor(c+".*",!0),f=0;f<d.length;f++)window.Clazz&&a.declarePackage(c+"."+d[f]),b.loadPackageClasspath(c+"."+d[f],e)};b.getClasspathFor=function(c,d,e){var f=O["#"+c];if(!f||d||e){var h,k;if(f){if(c=c.replace(/\./g,"/"),0<=(k=f.lastIndexOf(c))||0<=(k=c.lastIndexOf("/"))&&0<=(k=f.lastIndexOf(c.substring(0,k))))h=f.substring(0,k)}else{for(k=c.length+2;0<=(k=c.lastIndexOf(".",k-2))&&!(h=O["@"+c.substring(0,k)]););d||(c=c.replace(/\./g,"/"))}null==h&&(h=window.Clazz&&a.binaryFolders&&a.binaryFolders.length?
a.binaryFolders[0]:b.binaryFolders&&b.binaryFolders.length?b.binaryFolders[0]:"j2s");f=(h.lastIndexOf("/")==h.length-1?h:h+"/")+(d?"":c.lastIndexOf("/*")==c.length-2?c.substring(0,k+1):c+(!e?".js":"."!=e.charAt(0)?"."+e:e))}return f};b.ignore=function(){var a=1==arguments.length&&arguments[0]instanceof Array?a=arguments[0]:null,b=a?a.length:arguments.length;if(!a)for(var a=Array(b),c=0;c<b;c++)a[c]=arguments[c];E(a);for(c=0;c<b;c++)X["@"+a[c]]=1};b.onScriptLoading=function(){};b.onScriptLoaded=function(){};
b.onScriptInitialized=function(){};b.onScriptCompleted=function(){};b.onClassUnloaded=function(){};b.onGlobalLoaded=function(){};b.keepOnLoading=!0;var L={},X={},S=function(c,d,e){try{eval(e+";//# sourceURL="+c)}catch(f){if(a._isQuiet)return;c="[Java2Script] The required class file \n\n"+c+(0==e.indexOf("[Exception")&&e.indexOf("data: no")?"\nwas not found.\n":"\ncould not be loaded. Script error: "+f.message+" \n\ndata:\n\n"+e)+"\n\n"+a.getStackTrace();alert(c);a.alert(c);throw f;}b.onScriptLoaded(c,
...
b="r"+a;if(!ab[b])return ab[b]=1,d.random=a}},F=function(a){ya();return Aa(a,d)},G=function(a){ya();return za(d,a)},Ha=function(a){return pa(d,a)},Aa=function(a,b){var c;return b.name==a?b:(c=Za(a,b.musts))||(c=Za(a,b.optionals))?c:null},Za=function(a,b){for(var c=d.random,e=b.length;0<=--e;){var f=b[e];if(f.name==a||f.random!=c&&(f.random=c,f=Aa(a,f)))return f}return null},xa=function(a,b){return a.status==b&&(b!=w.STATUS_KNOWN||!e[a.path])&&(b==w.STATUS_DECLARED||!isClassDefined(a.name))},pa=function(a,
b){for(var c=a.musts.length;0<=--c;){var d=a.musts[c];if(xa(d,b)||(d=pa(d,b)))return d}return xa(a,b)?a:null},za=function(a,b){var c;return(c=na(a.musts,b))||(c=na(a.optionals,b))||xa(c=a,b)?c:null},na=function(a,b){if(a)for(var c=d.random,e=0;e<a.length;e++){var f=a[e];if(xa(f,b)||f.random!=c&&(f.random=c,f=za(f,b)))return f}return null},R={},ca=function(a,c,e,f){if(c instanceof Array){E(c);for(var h=0;h<c.length;h++)ca(a,c[h],e,f,c)}else{b._checkLoad&&!b._classPending[c]&&(b._classPending[c]=1,
0==b._classCountPending++&&(b._classCountOK=0),System.out.println("Loading class "+c));h=L["#"+c];h||(h=(h=F(c))?h:new w,h.name=c,h.path=O["#"+c]||"unknown",Q(h.path,c,h),h.status=w.STATUS_KNOWN,Ia(d,h,!1));ba(h,a,!0);5==arguments.length&&f&&(f.status=h.status,f.clazzList=arguments[4]);if(h.declaration=f)h.status=w.STATUS_CONTENT_LOADED;ba(h,e,!1)}},ba=function(a,b,c){if(b&&b.length){E(b);for(var d=0;d<b.length;d++){var e=b[d];if(e&&!isClassDefined(e)&&!X["@"+e]){var f=F(e);f||(f=new w,f.name=e,f.status=
w.STATUS_KNOWN);f.requiredBy=a;Ia(a,f,c)}}}};window.Clazz?a.load=ca:b.load=ca;var Q=function(a,b,c){var d="@"+a;if(a=L[d])if(a instanceof Array){for(var d=!1,e=0;e<a.length;e++)if(a[e].name==b){d=!0;break}d||a.push(c)}else L[d]=[a,c];else L[d]=c;L["#"+b]=c},ha=function(a){var c=a.name;if(!isClassDefined(c)&&!X["@"+c]){var d=b.getClasspathFor(c);a.path=d;Q(d,c,a);if(!e[d])return U(a,d,a.requiredBy,!1),!0}return!1},ta=b.runtimeKeyClass="java.lang.String",wa=[];b.getJ2SLibBase=function(){var a=window["j2s.lib"];
return a?a.base+("."==a.alias?"":(a.alias?a.alias:a.version?a.version:"1.0.0")+"/"):null};var N=!0,W=!1,Y=-1;b.MODE_SCRIPT=4;b.MODE_XHR=2;b.MODE_SYNC=1;b.setLoadingMode=function(a,c){var d=!0,e=!0;"string"==typeof a?(a=a.toLowerCase(),0<=a.indexOf("script")?e=!1:a.indexOf("async"),d=!1):a&b.MODE_SCRIPT?e=!1:d=!(a&b.MODE_SYNC);W=e;Y=(N=d)&&0<=c?c:-1;return d};var Ba=function(){if(!K&&isClassDefined(ta)){for(var a=wa,c=0;c<a.length;c++)b.loadClass(a[c][0],a[c][1]);wa=[]}};b.loadZJar=function(a,c){var d=
...
b.parents.push(a)}},ua=function(a){var b=a.parents;if(b)for(var c=b.length;0<=--c;)Ma(b[c].musts,a)||Ma(b[c].optionals,a)};b.unloadClassExt=function(a){B&&(B[a]=!1);if(O["#"+a]){var c=O["#"+a];O["#"+a]=null;var d=O["$"+c];Ma(d,a)&&(O["$"+c]=d)}if(c=F(a))c.status=w.STATUS_KNOWN,e[c.path]=!1;c=b.getClasspathFor(a);e[c]=!1;R[c]&&(R[c]=!1);b.onClassUnloaded(a)};a.binaryFolders=b.binaryFolders=[b.getJ2SLibBase()]})(a,a._Loader);a._LoaderProgressMonitor={};var $=a._LoaderProgressMonitor,ka=null,M=0,T=null,
...
--b;){var c=a.childNodes[b];if(c){c.childNodes&&c.childNodes.length&&ib(c);try{a.removeChild(c)}catch(d){}}}},kb=function(a){ka&&a==$.DEFAULT_OPACITY&&(window.clearTimeout(ka),ka=null);M=a;navigator.userAgent.toLowerCase();T.style.filter="Alpha(Opacity="+a+")";T.style.opacity=a/100},vb=function(){$.hideMonitor()},lb=!1,ma=function(){"none"!=T.style.display&&(M==$.DEFAULT_OPACITY?(ka=window.setTimeout(function(){ma()},750),M-=5):0<=M-10?(kb(M-10),ka=window.setTimeout(function(){ma()},40)):T.style.display=
"none")},B=a.Console,U=System;B.maxTotalLines=1E4;B.setMaxTotalLines=function(a){B.maxTotalLines=0<a?a:999999};B.maxLatency=40;B.setMaxLatency=function(a){B.maxLatency=0<a?a:40};B.pinning=!1;B.enablePinning=function(a){B.pinning=a};B.linesCount=0;B.metLineBreak=!1;B.createConsoleWindow=function(){var a=document.createElement("DIV");a.style.cssText="font-family:monospace, Arial, sans-serif;";document.body.appendChild(a);return a};var aa=String.fromCharCode(160),aa=aa+(aa+aa+aa);B.consoleOutput=function(a,
...
a=a.replace(/\t/g,aa);for(var h=a.split(/\r\n|\r|\n/g),d=0,k=h.length-1;d<=k;d++){var l=null;if(B.metLineBreak||0==B.linesCount||1>c.childNodes.length)l=document.createElement("DIV"),c.appendChild(l),l.style.whiteSpace="nowrap",B.linesCount++;else try{l=c.childNodes[c.childNodes.length-1]}catch(m){l=document.createElement("DIV"),c.appendChild(l),l.style.whiteSpace="nowrap",B.linesCount++}var r=document.createElement("SPAN");l.appendChild(r);r.style.whiteSpace="nowrap";b&&(r.style.color=b);l=h[d];
0==l.length&&(l=aa);r.appendChild(document.createTextNode(l));B.pinning||(c.scrollTop+=100);B.metLineBreak=d!=k||e}d=c.parentNode.className;!B.pinning&&(d&&-1!=d.indexOf("composite"))&&(c.parentNode.scrollTop=c.parentNode.scrollHeight);B.lastOutputTime=(new Date).getTime()};B.clear=function(){try{B.metLineBreak=!0;var a=window["j2s.lib"],b=a&&a.console;if(b&&(b=document.getElementById(b))){for(var c=b.childNodes,d=c.length;0<=--d;)b.removeChild(c[d]);B.linesCount=0}}catch(e){}};a.alert=function(a){B.consoleOutput(a+
"\r\n")};U.out.print=function(a){B.consoleOutput(a)};U.out.println=function(a){B.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n")};U.out.write=function(a,b,c){U.out.print(String.instantialize(a).substring(b,b+c))};U.err.__CLASS_NAME__="java.io.PrintStream";U.err.print=function(a){B.consoleOutput(a,"red")};U.err.println=function(a){B.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};U.err.write=function(a,b,c){U.err.print(String.instantialize(a).substring(b,
b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2015-08-25 09:07:19 -0500 (Tue, 25 Aug 2015) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.3.16_2015.08.25";
